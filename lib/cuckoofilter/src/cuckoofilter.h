...
namespace cuckoofilter {
    ...
    public:
        ...
        void writeFingerprint(std::string file){
            table_->writeFingerprint(file);
        }
        void readFingerprint(std::string file){
            table_->readFingerprint(file);
        }
        ...
        void CompareCF(const CuckooFilter);
    ...
    void 
    CuckooFilter<ItemType, bits_per_item, TableType>::CompareCF(CuckooFilter cf2){
    ...
    CuckooFilter<ItemType, bits_per_item, TableType>::Add(
        ...
        //std::cout<< "Hash Value: " << hv<< "\t index: "<< index << "\t tag: "<<tag << std::endl;
    ...
    CuckooFilter<ItemType, bits_per_item, TableType>::AddImpl(
        ...
        for (uint32_t count = 0; count < kMaxCuckooCount; count++) {
            ...
            if (kickout) {
                curtag = oldtag;
                //std::cout << "kickout count: " << count<< std::endl;
            }
